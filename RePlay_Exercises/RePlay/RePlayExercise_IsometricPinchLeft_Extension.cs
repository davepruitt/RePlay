...
{
    public class RePlayExercise_IsometricPinchLeft_Extension : RePlayExercise_IsometricPinchLeft
    {
        #region Constructor

        public RePlayExercise_IsometricPinchLeft_Extension(ReplayMicrocontroller c, Activity a, double gain)
            : base(c, a, gain)
        {
            SinglePolarity = true;
        ...
        public RePlayExercise_IsometricPinchLeft_Extension(Activity a, double gain)
            : base(a, gain)
        {
            SinglePolarity = true;
            ForceAlternation = false;
