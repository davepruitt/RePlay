...
{
    public class RePlayExercise_IsometricPinch_Flexion : RePlayExercise_IsometricPinch
    {
        #region Constructor

        public RePlayExercise_IsometricPinch_Flexion(ReplayMicrocontroller c, Activity a, double gain)
            : base(c, a, gain)
        {
            SinglePolarity = true;
        ...
        public RePlayExercise_IsometricPinch_Flexion(Activity a, double gain)
            : base(a, gain)
        {
            SinglePolarity = true;
            ForceAlternation = false;
